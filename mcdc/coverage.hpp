...
public:
	...
	CoverageResult reduce(std::ostream& os, bool fullMode = false);
...
protected:
	...
	void findDominatingVector(TableVector &firstDimension, TableVector &secondDimension, BestCostFunction &bcf, const bool dropOuterAndNotInner);
